...
const ItemDetails = () => {
  ...
  const Tokens = [
    ...
    {
      value: "0x2Fa2142496B29A82899f336ebfA8481Ac1666605",
      label: "Messi",
      icon: "letter-f-initial-icon-logo-template_23987-54.avif",
    },
  ];
                        ...
                        >
                          <div className="author-profile d-flex flex-wrap align-items-center gap-15">
                            <div className="author-p-thumb">
                              <Link
                                href={"/profile/" + query.seller.owner_address}
                              >
                                <a>
                                  <img
                            ...
                            <div className="author-p-info">
                              ...
                              <h6>
                                <Link
                                  href={
                                    "/profile/" + query.seller.owner_address
                                  }
                                >
                                  <a>{`${query.seller.owner_address}`}</a>
                                </Link>
                              </h6>
                            </div>
                          </div>
